...
let playerXIcon = "fas fa-heart"; //class name of fontawesome cross icon
let playerOIcon = "fas fa-globe"; //class name of fontawesome circle icon
...
function selectWinner() {
  ...
  if (
    ...
    wonText.innerHTML = "I love you, Chlo fii se khele"; //displaying winning text with passing playerSign (X or O)
  } else {
